create database investarin_gudang;
...
values
(101, 'Gamming Laptop G5', 'ELEC-442-X', 'Laptop', 15500000, 12, 'A-01', 'Lulus'),
...
(107, 'Smarthphone Z Flip', 'ELEC-112-Y', 'Smartphone',	14000000, 4, 'A-03', 'Lulus'),
(108, 'standing Desk', 'FURN-882-Q', 'Furniture', 5000000, 15, 'C-02', 'Lulus'),
(109, 'Headsset Gaming RGB', 'ACC-404-X', 'Aksesoris', 1100000,	25,	NULL,	'Lulus'),
